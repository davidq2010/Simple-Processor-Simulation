...
int main(int argc, char const *argv[])
{
	...
	testALUOutput(alu, 1000000ul, 500000ul, 0, 0, 0,  1500000ul, 0);
	cout << endl;
	testALUOutput(alu, 100'0000ul, 500000ul, 1, 0, 0,  500000ul, 0);
	cout << endl;
	testALUOutput(alu, 500000ul, 1000000ul, 1, 0, 0,  0xFFFFFFFFll - 499999, 0);
	cout << endl;
	testALUOutput(alu, 500000ul, 1000000ul, 1, 1, 0,  1, 0);
	cout << endl;
	testALUOutput(alu, 1000000ul, 500000ul, 1, 1, 0,  0, 0);
	cout << endl;
	testALUOutput(alu, 500000ul, 1000000ul, 1, 0, 1,  0xFFFFFFFFll - 499999, 0);
	cout << endl;
	testALUOutput(alu, 500000ul,  500000ul, 1, 0, 1,  0, 1);
	cout << endl;
}
